...
- tidyverse is a useful collection of packages, though sometimes creates confusion versus "base"
...
- `read_csv` (in the tidyverse) is generally faster/better than `read.csv`
...
## Exercise 2: Extract one column ($) and assign it to a new variable (you make up the name)
